...
> **Covered in:** [Model and artifact security — Easy mode: mental model](README.md#easy-mode-mental-model)
...
> **Covered in:** [Model and artifact security — Command and configuration lab](README.md#command-and-configuration-lab)
...
> **Covered in:** [Model and artifact security — Beginner → mid-level → senior learning path](README.md#beginner-mid-level-senior-learning-path)
...
> **Covered in:** [Model and artifact security — Hands-on practice: setup → failure → verification → cleanup](README.md#hands-on-practice-setup-failure-verification-cleanup)
