...
> **Covered in:** [Serving failure modes — Complete curriculum checklist](README.md#complete-curriculum-checklist)
...
> **Covered in:** [Serving failure modes — Hands-on practice: setup → failure → verification → cleanup](README.md#hands-on-practice-setup-failure-verification-cleanup)
...
> **Covered in:** [Serving failure modes — Command and configuration lab](README.md#command-and-configuration-lab)
...
> **Covered in:** [Serving failure modes — Beginner → mid-level → senior learning path](README.md#beginner-mid-level-senior-learning-path)
