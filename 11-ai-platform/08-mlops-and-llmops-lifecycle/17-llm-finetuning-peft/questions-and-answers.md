...
> **Covered in:** [LLM fine-tuning, PEFT and adapter operations — Architecture and lifecycle](README.md#architecture-and-lifecycle)
...
> **Covered in:** [LLM fine-tuning, PEFT and adapter operations — Easy mode: purpose and mental model](README.md#easy-mode-purpose-and-mental-model)
...
> **Covered in:** [LLM fine-tuning, PEFT and adapter operations — Command lab](README.md#command-lab)
...
> **Covered in:** [LLM fine-tuning, PEFT and adapter operations — Real-world exercise: easy → hard](README.md#real-world-exercise-easy-hard)
...
> **Covered in:** [LLM fine-tuning, PEFT and adapter operations — Availability and failure modes](README.md#availability-and-failure-modes)
