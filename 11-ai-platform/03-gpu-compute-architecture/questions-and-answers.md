...
> **Covered in:** [GPU-compute architecture — GPU architecture and memory math](README.md#gpu-architecture-and-memory-math)
...
> **Covered in:** [GPU-compute architecture — Complete curriculum checklist](README.md#complete-curriculum-checklist)
...
> **Covered in:** [GPU-compute architecture — Command and configuration lab](README.md#command-and-configuration-lab)
...
> **Covered in:** [GPU-compute architecture — Beginner → mid-level → senior learning path](README.md#beginner-mid-level-senior-learning-path)
