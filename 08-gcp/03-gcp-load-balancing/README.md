...
<!-- chapter-guide:start -->
> **Step 172 of 373 — 08.03**
>
> **Builds on:** [GCP networking](../02-gcp-networking/README.md)
>
> **Now:** Learn **GCP load balancing** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [GCP compute and containers](../04-gcp-compute-and-containers/README.md).
<!-- chapter-guide:end -->
...
**GCP load balancing** is easiest to understand as one part of a larger path. The subject is an API-managed resource under organization, folder and project boundaries. Identity and policy authorize a control-plane change, while regional or global managed infrastructure produces the data-path behavior.

The chapter focuses on Global external Application Load Balancer, Regional external Application Load Balancer, Internal Application Load Balancer, External proxy Network Load Balancer. These are connected mechanisms, not vocabulary to memorize. Integrate every part of GCP load balancing into one secure, reliable, observable, supportable and cost-aware production capability The explanations below first build the simple model, then add the exact system behavior and production consequences.
...
In this chapter, **GCP load balancing** is the next layer of that evolution. Its modern purpose is to integrate every part of GCP load balancing into one secure, reliable, observable, supportable and cost-aware production capability. The exact product surface may change by version, but the underlying state, request path and failure boundaries remain the durable ideas to learn.
...
flowchart LR
  ...
  B --> C["GCP load balancing: service data plane"]
...
For **GCP load balancing**, the important stages are Global external Application Load Balancer, Regional external Application Load Balancer, Internal Application Load Balancer, External proxy Network Load Balancer, Passthrough Network Load Balancer, Internal passthrough Network Load Balancer, Backend services, URL maps, Health checks, Managed certificates, Global anycast, Session affinity. Their boundaries explain where identity is checked, where state becomes durable, where capacity is consumed, how failures propagate and which signal can distinguish one layer from another. A production explanation should follow the actual path rather than treating each term as an isolated definition.
...
**What it is.** The term Global external Application Load Balancer refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
**What it is.** The term Regional external Application Load Balancer refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
**What it is.** The term Internal Application Load Balancer refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
**What it is.** The term External proxy Network Load Balancer is an intermediary boundary that accepts a caller connection and applies routing, policy, transformation or observability before forwarding to a selected backend within GCP load balancing.
...
**What it is.** The term Passthrough Network Load Balancer refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
**What it is.** The term Internal passthrough Network Load Balancer refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
**What it is.** The term Backend services refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
**What it is.** The term URL maps refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
**What it is.** The term Health checks refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
**What it is.** The term Managed certificates is a trust-control mechanism that identifies an actor or protected asset and enforces which action is allowed under explicit context, with audit, rotation, revocation and recovery behavior within GCP load balancing.
...
**What it is.** The term Global anycast refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
**What it is.** The term Session affinity refers to a Google Cloud control- or data-plane mechanism bounded by resource hierarchy, location, identity, quota and service contract within GCP load balancing.
...
A healthy run returns the intended identity/context, exits successfully and shows the expected object or response without a new warning, retry loop or saturation signal. A failure is useful evidence: preserve the exact exit code, status/reason, timestamp and target, then inspect the immediately adjacent layer before changing anything. This makes the example part of the explanation of **GCP load balancing**, not merely a list to copy.
...
Build a small, safe proof of **GCP load balancing** and explain the result in your own words. The goal is not command completion; it is to connect input, internal mechanism, observable state and user outcome.
...
**Reading path:** [← Back: GCP networking](../02-gcp-networking/README.md) · [Questions](questions-and-answers.md) · [Next: GCP compute and containers →](../04-gcp-compute-and-containers/README.md)
