...
> **Covered in:** [Reliability scenarios — Complete curriculum checklist](README.md#complete-curriculum-checklist)
...
> **Covered in:** [Reliability scenarios — Hands-on practice: setup → failure → verification → cleanup](README.md#hands-on-practice-setup-failure-verification-cleanup)
...
> **Covered in:** [Reliability scenarios — Command and configuration lab](README.md#command-and-configuration-lab)
...
> **Covered in:** [Reliability scenarios — Beginner → mid-level → senior learning path](README.md#beginner-mid-level-senior-learning-path)
