...
- [Compliance evidence](compliance-evidence/README.md) — [questions and answers](compliance-evidence/questions-and-answers.md)
- [Identity security](identity-security/README.md) — [questions and answers](identity-security/questions-and-answers.md)
- [Kubernetes security](kubernetes-security/README.md) — [questions and answers](kubernetes-security/questions-and-answers.md)
- [Network security](network-security/README.md) — [questions and answers](network-security/questions-and-answers.md)
- [Secret management](secret-management/README.md) — [questions and answers](secret-management/questions-and-answers.md)
- [Software supply chain](software-supply-chain/README.md) — [questions and answers](software-supply-chain/questions-and-answers.md)
- [Vulnerability management](vulnerability-management/README.md) — [questions and answers](vulnerability-management/questions-and-answers.md)
<!-- child-topic-toc:end -->
...
- [34.1 Identity security](identity-security/README.md) — [Q&A](identity-security/questions-and-answers.md)
- [34.2 Secret management](secret-management/README.md) — [Q&A](secret-management/questions-and-answers.md)
- [34.3 Network security](network-security/README.md) — [Q&A](network-security/questions-and-answers.md)
- [34.4 Software supply chain](software-supply-chain/README.md) — [Q&A](software-supply-chain/questions-and-answers.md)
- [34.5 Kubernetes security](kubernetes-security/README.md) — [Q&A](kubernetes-security/questions-and-answers.md)
- [34.6 Vulnerability management](vulnerability-management/README.md) — [Q&A](vulnerability-management/questions-and-answers.md)
- [34.7 Compliance evidence](compliance-evidence/README.md) — [Q&A](compliance-evidence/questions-and-answers.md)
