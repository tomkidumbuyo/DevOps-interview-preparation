...
> **Covered in:** [Identity security — Complete curriculum checklist](README.md#complete-curriculum-checklist)
...
> **Covered in:** [Identity security — Easy mode: mental model](README.md#easy-mode-mental-model)
...
> **Covered in:** [Identity security — Command and configuration lab](README.md#command-and-configuration-lab)
...
> **Covered in:** [Identity security — Beginner → mid-level → senior learning path](README.md#beginner-mid-level-senior-learning-path)
...
**Reading path:** [← Back: Platform and cloud security](../README.md) · [Study note](README.md) · [Next: Secret management →](../02-secret-management/README.md)
