...
<!-- chapter-guide:start -->
> **Step 233 of 373 — 10.03.05**
>
> **Builds on:** [Software supply chain](../04-software-supply-chain/README.md)
>
> **Now:** Learn **Kubernetes security** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Vulnerability management](../06-vulnerability-management/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: Software supply chain](../04-software-supply-chain/README.md) · [Questions](questions-and-answers.md) · [Next: Vulnerability management →](../06-vulnerability-management/README.md)
