...
> **Covered in:** [CircleCI — Mental model and file structure](README.md#mental-model-and-file-structure)
...
> **Covered in:** [CircleCI — Reusable configuration and orbs](README.md#reusable-configuration-and-orbs)
...
> **Covered in:** [CircleCI — Top-level configuration format](README.md#top-level-configuration-format)
...
> **Covered in:** [CircleCI — Full practical build/test/deploy example](README.md#full-practical-buildtestdeploy-example)
...
> **Covered in:** [CircleCI — Environment variables, contexts, secrets and OIDC](README.md#environment-variables-contexts-secrets-and-oidc)
...
> **Covered in:** [CircleCI — Pipelines, parameters and dynamic configuration](README.md#pipelines-parameters-and-dynamic-configuration)
...
> **Covered in:** [CircleCI — Security and senior architecture checklist](README.md#security-and-senior-architecture-checklist)
