...
<!-- chapter-guide:start -->
> **Step 205 of 373 — 09.03.05**
>
> **Builds on:** [GitLab CI](../04-gitlab-ci/README.md)
>
> **Now:** Learn **Jenkins** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Deployment strategies](../06-deployment-strategies/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: GitLab CI](../04-gitlab-ci/README.md) · [Questions](questions-and-answers.md) · [Next: Deployment strategies →](../06-deployment-strategies/README.md)
