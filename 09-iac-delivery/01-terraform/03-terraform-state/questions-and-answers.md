...
> **Covered in:** [Terraform state — Complete curriculum checklist](README.md#complete-curriculum-checklist)
...
> **Covered in:** [Terraform state — Command and configuration lab](README.md#command-and-configuration-lab)
...
> **Covered in:** [Terraform state — Hands-on practice: setup → failure → verification → cleanup](README.md#hands-on-practice-setup-failure-verification-cleanup)
...
> **Covered in:** [Terraform state — Beginner → mid-level → senior learning path](README.md#beginner-mid-level-senior-learning-path)
...
> **Covered in:** [Terraform state — Senior design checklist](README.md#senior-design-checklist)
