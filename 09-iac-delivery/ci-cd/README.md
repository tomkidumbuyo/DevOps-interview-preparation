...
- [CD fundamentals](cd-fundamentals/README.md) — [questions and answers](cd-fundamentals/questions-and-answers.md)
- [CI/CD security](ci-cd-security/README.md) — [questions and answers](ci-cd-security/questions-and-answers.md)
- [CI fundamentals](ci-fundamentals/README.md) — [questions and answers](ci-fundamentals/questions-and-answers.md)
- [CircleCI](circleci/README.md) — [questions and answers](circleci/questions-and-answers.md)
- [Deployment strategies](deployment-strategies/README.md) — [questions and answers](deployment-strategies/questions-and-answers.md)
- [GitHub Actions](github-actions/README.md) — [questions and answers](github-actions/questions-and-answers.md)
- [GitLab CI](gitlab-ci/README.md) — [questions and answers](gitlab-ci/questions-and-answers.md)
- [GitOps](gitops/README.md) — [questions and answers](gitops/questions-and-answers.md)
- [Jenkins](jenkins/README.md) — [questions and answers](jenkins/questions-and-answers.md)
<!-- child-topic-toc:end -->
...
- [31.1 CI fundamentals](ci-fundamentals/README.md) — [Q&A](ci-fundamentals/questions-and-answers.md)
- [31.2 CD fundamentals](cd-fundamentals/README.md) — [Q&A](cd-fundamentals/questions-and-answers.md)
- [31.3 GitHub Actions](github-actions/README.md) — [Q&A](github-actions/questions-and-answers.md)
- [31.4 GitLab CI](gitlab-ci/README.md) — [Q&A](gitlab-ci/questions-and-answers.md)
- [31.5 Jenkins](jenkins/README.md) — [Q&A](jenkins/questions-and-answers.md)
- [31.6 Deployment strategies](deployment-strategies/README.md) — [Q&A](deployment-strategies/questions-and-answers.md)
- [31.7 GitOps](gitops/README.md) — [Q&A](gitops/questions-and-answers.md)
- [31.8 CI/CD security](ci-cd-security/README.md) — [Q&A](ci-cd-security/questions-and-answers.md)
