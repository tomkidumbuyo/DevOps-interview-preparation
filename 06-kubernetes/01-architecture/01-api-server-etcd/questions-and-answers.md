...
> **Covered in:** [Kubernetes API server and etcd — Architecture and lifecycle](README.md#architecture-and-lifecycle)
...
> **Covered in:** [Kubernetes API server and etcd — Easy mode: purpose and mental model](README.md#easy-mode-purpose-and-mental-model)
...
> **Covered in:** [Kubernetes API server and etcd — Command lab](README.md#command-lab)
...
> **Covered in:** [Kubernetes API server and etcd — Availability and failure modes](README.md#availability-and-failure-modes)
