...
> **Covered in:** [Kubernetes authentication, RBAC and ServiceAccounts — Easy mode: purpose and mental model](README.md#easy-mode-purpose-and-mental-model)
...
> **Covered in:** [Kubernetes authentication, RBAC and ServiceAccounts — Architecture and lifecycle](README.md#architecture-and-lifecycle)
...
> **Covered in:** [Kubernetes authentication, RBAC and ServiceAccounts — Command lab](README.md#command-lab)
...
> **Covered in:** [Kubernetes authentication, RBAC and ServiceAccounts — Real-world exercise: easy → hard](README.md#real-world-exercise-easy-hard)
...
> **Covered in:** [Kubernetes authentication, RBAC and ServiceAccounts — Availability and failure modes](README.md#availability-and-failure-modes)
