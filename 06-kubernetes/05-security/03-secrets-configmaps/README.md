...
<!-- chapter-guide:start -->
> **Step 078 of 373 — 06.05.03**
>
> **Builds on:** [Pod and node workload security](../02-pod-security/README.md)
>
> **Now:** Learn **Kubernetes Secrets and ConfigMaps** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Kubernetes admission policies and webhooks](../04-admission-policies-webhooks/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: Pod and node workload security](../02-pod-security/README.md) · [Questions](questions-and-answers.md) · [Next: Kubernetes admission policies and webhooks →](../04-admission-policies-webhooks/README.md)
