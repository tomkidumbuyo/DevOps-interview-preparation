...
> **Covered in:** [Pod and node workload security — Architecture and lifecycle](README.md#architecture-and-lifecycle)
...
> **Covered in:** [Pod and node workload security — Command lab](README.md#command-lab)
...
> **Covered in:** [Pod and node workload security — Real-world exercise: easy → hard](README.md#real-world-exercise-easy-hard)
...
> **Covered in:** [Pod and node workload security — Security model](README.md#security-model)
...
> **Covered in:** [Pod and node workload security — Availability and failure modes](README.md#availability-and-failure-modes)
