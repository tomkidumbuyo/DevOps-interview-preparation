...
> **Covered in:** [GPU Operator, device plugins and DRA — Architecture and lifecycle](README.md#architecture-and-lifecycle)
...
> **Covered in:** [GPU Operator, device plugins and DRA — Easy mode: purpose and mental model](README.md#easy-mode-purpose-and-mental-model)
...
> **Covered in:** [GPU Operator, device plugins and DRA — Command lab](README.md#command-lab)
...
> **Covered in:** [GPU Operator, device plugins and DRA — Availability and failure modes](README.md#availability-and-failure-modes)
