...
<!-- chapter-guide:start -->
> **Step 069 of 373 — 06.03.03**
>
> **Builds on:** [CNI, kube-proxy and eBPF data planes](../02-cni-kubeproxy-ebpf/README.md)
>
> **Now:** Learn **Kubernetes NetworkPolicy** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Ingress and Gateway API](../04-ingress-gateway-api/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: CNI, kube-proxy and eBPF data planes](../02-cni-kubeproxy-ebpf/README.md) · [Questions](questions-and-answers.md) · [Next: Ingress and Gateway API →](../04-ingress-gateway-api/README.md)
