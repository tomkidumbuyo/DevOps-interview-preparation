...
<!-- chapter-guide:start -->
> **Step 063 of 373 — 06.02.03**
>
> **Builds on:** [Deployments and ReplicaSets](../02-deployments/README.md)
>
> **Now:** Learn **StatefulSets and DaemonSets** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Jobs and CronJobs](../04-jobs-cronjobs/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: Deployments and ReplicaSets](../02-deployments/README.md) · [Questions](questions-and-answers.md) · [Next: Jobs and CronJobs →](../04-jobs-cronjobs/README.md)
