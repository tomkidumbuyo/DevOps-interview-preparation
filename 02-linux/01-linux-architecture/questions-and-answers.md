...
> **Covered in:** [Linux architecture — Complete curriculum checklist](README.md#complete-curriculum-checklist)
...
> **Covered in:** [Linux architecture — Easy mode: mental model](README.md#easy-mode-mental-model)
...
> **Covered in:** [Linux architecture — Command and configuration lab](README.md#command-and-configuration-lab)
...
> **Covered in:** [Linux architecture — Beginner → mid-level → senior learning path](README.md#beginner-mid-level-senior-learning-path)
...
**Reading path:** [← Back: Linux and operating systems](../README.md) · [Study note](README.md) · [Next: Filesystems →](../02-filesystems/README.md)
