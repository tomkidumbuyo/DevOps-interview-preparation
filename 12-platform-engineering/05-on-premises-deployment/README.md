...
**On-premises deployment** is easiest to understand as one part of a larger path. The subject is a product and control plane for engineering teams. Users request a capability through a supported interface, automation provisions it with guardrails, and the platform reports ownership, health, cost and lifecycle state.

The chapter focuses on Bare-metal Kubernetes, Virtualized Kubernetes, Air-gapped installation, Private image registries. These are connected mechanisms, not vocabulary to memorize. Integrate every part of On-premises deployment into one secure, reliable, observable, supportable and cost-aware production capability The explanations below first build the simple model, then add the exact system behavior and production consequences.
...
In this chapter, **On-premises deployment** is the next layer of that evolution. Its modern purpose is to integrate every part of On-premises deployment into one secure, reliable, observable, supportable and cost-aware production capability. The exact product surface may change by version, but the underlying state, request path and failure boundaries remain the durable ideas to learn.
...
flowchart LR
  ...
  B --> C["On-premises deployment: provisioned capability"]
...
For **On-premises deployment**, the important stages are Bare-metal Kubernetes, Virtualized Kubernetes, Air-gapped installation, Private image registries, Offline artifact bundles, GPU driver management, Hardware compatibility, Storage integration, Network integration, Load-balancer integration, DNS integration, Identity integration, Certificate management, License management, Upgrade orchestration, Backup and restoration, Remote diagnostics, Limited or disconnected telemetry, Customer support procedures. Their boundaries explain where identity is checked, where state becomes durable, where capacity is consumed, how failures propagate and which signal can distinguish one layer from another. A production explanation should follow the actual path rather than treating each term as an isolated definition.
...
**What it is.** The term Bare-metal Kubernetes refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term Virtualized Kubernetes refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term Air-gapped installation refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term Private image registries refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term Offline artifact bundles is a delivery mechanism that binds reviewed source to an immutable revision and moves that revision through validation and bounded rollout toward verified runtime state within On-premises deployment.
...
**What it is.** The term GPU driver management refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term Hardware compatibility refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term Storage integration holds state beyond one operation or process lifetime and therefore must define durability, consistency, concurrency, replication, backup, restore and deletion semantics within On-premises deployment.
...
**What it is.** The term Network integration refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term Load-balancer integration refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term DNS integration refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term Identity integration is a trust-control mechanism that identifies an actor or protected asset and enforces which action is allowed under explicit context, with audit, rotation, revocation and recovery behavior within On-premises deployment.
...
**What it is.** The term Certificate management is a trust-control mechanism that identifies an actor or protected asset and enforces which action is allowed under explicit context, with audit, rotation, revocation and recovery behavior within On-premises deployment.
...
**What it is.** The term License management refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
**What it is.** The term Remote diagnostics refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
#### Limited or disconnected telemetry

**What it is.** The term Limited or disconnected telemetry is an observability signal that records a defined aspect of runtime behavior; its schema, context, sampling, retention and query semantics determine which hypotheses it can distinguish within On-premises deployment.
...
**What it is.** The term Customer support procedures refers to a platform-product mechanism that turns a user intent into a governed, supported and observable capability within On-premises deployment.
...
A healthy run returns the intended identity/context, exits successfully and shows the expected object or response without a new warning, retry loop or saturation signal. A failure is useful evidence: preserve the exact exit code, status/reason, timestamp and target, then inspect the immediately adjacent layer before changing anything. This makes the example part of the explanation of **On-premises deployment**, not merely a list to copy.
...
Build a small, safe proof of **On-premises deployment** and explain the result in your own words. The goal is not command completion; it is to connect input, internal mechanism, observable state and user outcome.
