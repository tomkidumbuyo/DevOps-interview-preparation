...
- [Foundations service leaves](services/README.md) — [questions and answers](services/questions-and-answers.md)
<!-- child-topic-toc:end -->
...
- [AWS IAM](services/iam/README.md) — [Q&A](services/iam/questions-and-answers.md)
- [AWS Organizations](services/organizations/README.md) — [Q&A](services/organizations/questions-and-answers.md)
- [AWS STS, federation and IAM Identity Center](services/sts-identity-center/README.md) — [Q&A](services/sts-identity-center/questions-and-answers.md)
- [AWS Control Tower, tagging, quotas and governance](services/control-tower-governance/README.md) — [Q&A](services/control-tower-governance/questions-and-answers.md)
