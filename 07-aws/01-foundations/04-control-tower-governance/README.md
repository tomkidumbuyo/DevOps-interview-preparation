...
<!-- chapter-guide:start -->
> **Step 108 of 373 — 07.01.04**
>
> **Builds on:** [AWS STS, federation and IAM Identity Center](../03-sts-identity-center/README.md)
>
> **Now:** Learn **AWS Control Tower, tagging, quotas and governance** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Networking](../../02-networking/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: AWS STS, federation and IAM Identity Center](../03-sts-identity-center/README.md) · [Questions](questions-and-answers.md) · [Next: Networking →](../../02-networking/README.md)
