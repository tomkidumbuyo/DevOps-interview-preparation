...
<!-- chapter-guide:start -->
> **Step 105 of 373 — 07.01.01**
>
> **Builds on:** [Foundations](../README.md)
>
> **Now:** Learn **AWS IAM** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [AWS Organizations](../02-organizations/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: Foundations](../README.md) · [Questions](questions-and-answers.md) · [Next: AWS Organizations →](../02-organizations/README.md)
