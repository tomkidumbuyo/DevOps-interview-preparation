...
<!-- chapter-guide:start -->
> **Step 164 of 373 — 07.11**
>
> **Builds on:** [AWS Service Catalog and Proton](../10-infrastructure-delivery/04-service-catalog-proton/README.md)
>
> **Now:** Learn **Ai Platform** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Amazon Bedrock](01-bedrock/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: AWS Service Catalog and Proton](../10-infrastructure-delivery/04-service-catalog-proton/README.md) · [Questions](questions-and-answers.md) · [Next: Amazon Bedrock →](01-bedrock/README.md)
