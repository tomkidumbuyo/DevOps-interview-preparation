...
<!-- chapter-guide:start -->
> **Step 160 of 373 — 07.10.01**
>
> **Builds on:** [Infrastructure Delivery](../README.md)
>
> **Now:** Learn **AWS CloudFormation** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [AWS CDK](../02-cdk/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: Infrastructure Delivery](../README.md) · [Questions](questions-and-answers.md) · [Next: AWS CDK →](../02-cdk/README.md)
