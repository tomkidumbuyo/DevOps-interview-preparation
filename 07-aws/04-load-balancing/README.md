...
<!-- chapter-guide:start -->
> **Step 121 of 373 — 07.04**
>
> **Builds on:** [EC2 Auto Scaling](../03-compute/03-ec2-auto-scaling/README.md)
>
> **Now:** Learn **Load Balancing** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Application Load Balancer](01-alb/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: EC2 Auto Scaling](../03-compute/03-ec2-auto-scaling/README.md) · [Questions](questions-and-answers.md) · [Next: Application Load Balancer →](01-alb/README.md)
