...
<!-- chapter-guide:start -->
> **Step 122 of 373 — 07.04.01**
>
> **Builds on:** [Load Balancing](../README.md)
>
> **Now:** Learn **Application Load Balancer** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Network Load Balancer](../02-nlb/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: Load Balancing](../README.md) · [Questions](questions-and-answers.md) · [Next: Network Load Balancer →](../02-nlb/README.md)
