...
<!-- chapter-guide:start -->
> **Step 152 of 373 — 07.09.01**
>
> **Builds on:** [Security Operations](../README.md)
>
> **Now:** Learn **AWS KMS** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [AWS Secrets Manager and Parameter Store](../02-secrets-manager/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: Security Operations](../README.md) · [Questions](questions-and-answers.md) · [Next: AWS Secrets Manager and Parameter Store →](../02-secrets-manager/README.md)
