...
<!-- chapter-guide:start -->
> **Step 144 of 373 — 07.08**
>
> **Builds on:** [Amazon OpenSearch Service](../07-databases/05-opensearch/README.md)
>
> **Now:** Learn **Messaging Serverless** from its mental model through production ownership.
>
...
**Reading path:** [← Back: Amazon OpenSearch Service](../07-databases/05-opensearch/README.md) · [Questions](questions-and-answers.md) · [Next: Amazon SQS →](01-sqs/README.md)
