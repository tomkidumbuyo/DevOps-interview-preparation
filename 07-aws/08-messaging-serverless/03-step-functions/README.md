...
<!-- chapter-guide:start -->
> **Step 147 of 373 — 07.08.03**
>
> **Builds on:** [Amazon SNS and EventBridge](../02-sns-eventbridge/README.md)
>
> **Now:** Learn **AWS Step Functions** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Kinesis Data Streams and Amazon MSK](../04-kinesis-msk/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: Amazon SNS and EventBridge](../02-sns-eventbridge/README.md) · [Questions](questions-and-answers.md) · [Next: Kinesis Data Streams and Amazon MSK →](../04-kinesis-msk/README.md)
