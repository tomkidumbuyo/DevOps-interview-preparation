...
<!-- chapter-guide:start -->
> **Step 126 of 373 — 07.05**
>
> **Builds on:** [AWS Global Accelerator](../04-load-balancing/04-global-accelerator/README.md)
>
> **Now:** Learn **Storage** from its mental model through production ownership.
>
> **Then:** Rehearse the linked questions and continue to [Amazon S3](01-s3/README.md).
<!-- chapter-guide:end -->
...
**Reading path:** [← Back: AWS Global Accelerator](../04-load-balancing/04-global-accelerator/README.md) · [Questions](questions-and-answers.md) · [Next: Amazon S3 →](01-s3/README.md)
