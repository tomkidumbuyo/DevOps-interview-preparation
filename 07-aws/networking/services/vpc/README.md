...
Design regional IP, subnet and routing domains and reason about every forward and return packet path.

```mermaid
flowchart LR
  I[identity and desired state] --> C[Amazon VPC control plane]
  C --> D[Amazon VPC data plane]
...
For Amazon VPC, draw a real request/resource path and label where these mechanisms act: VPC CIDR, Subnet, Route table, Internet gateway, Egress-only internet gateway, ENI, IPAM, DHCP options, VPC Flow Logs, Reachability Analyzer. State which parts are control plane versus data plane, regional versus zonal/global, synchronous versus asynchronous, and customer versus provider responsibility.
...
1. **Easy:** inventory one healthy Amazon VPC resource and draw identity/control/data/dependency paths.
...
Explain Amazon VPC in five passes: purpose/selection, mechanism/lifecycle, security/failure, operation/commands, and architecture/economics. Then complete the separate [answered question bank](questions-and-answers.md) without looking at these notes.
