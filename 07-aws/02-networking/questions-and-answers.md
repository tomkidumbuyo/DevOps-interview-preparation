...
> **Covered in:** [Networking — Addressing, subnets and routes](README.md#addressing-subnets-and-routes)
...
> **Covered in:** [Networking — Security, availability, performance, observability and cost](README.md#security-availability-performance-observability-and-cost)
...
> **Covered in:** [Networking — Packet-path runbook](README.md#packet-path-runbook)
...
> **Covered in:** [Networking — Security model](README.md#security-model)
...
> **Covered in:** [VPC endpoints and AWS PrivateLink — Architecture and lifecycle](04-endpoints-privatelink/README.md#architecture-and-lifecycle)
