...
> **Covered in:** [Security groups and network ACLs — Architecture and lifecycle](README.md#architecture-and-lifecycle)
...
> **Covered in:** [Security groups and network ACLs — Real-world exercise: easy → hard](README.md#real-world-exercise-easy-hard)
...
> **Covered in:** [Security groups and network ACLs — Command lab](README.md#command-lab)
...
> **Covered in:** [Security groups and network ACLs — Security model](README.md#security-model)
...
> **Covered in:** [Security groups and network ACLs — Detailed learning notes](README.md#detailed-learning-notes)
...
> **Covered in:** [Security groups and network ACLs — Availability and failure modes](README.md#availability-and-failure-modes)
