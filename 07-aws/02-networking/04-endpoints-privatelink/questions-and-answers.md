...
> **Covered in:** [VPC endpoints and AWS PrivateLink — Architecture and lifecycle](README.md#architecture-and-lifecycle)
...
> **Covered in:** [VPC endpoints and AWS PrivateLink — Easy mode: purpose and mental model](README.md#easy-mode-purpose-and-mental-model)
...
> **Covered in:** [VPC endpoints and AWS PrivateLink — Real-world exercise: easy → hard](README.md#real-world-exercise-easy-hard)
...
> **Covered in:** [VPC endpoints and AWS PrivateLink — Command lab](README.md#command-lab)
...
> **Covered in:** [VPC endpoints and AWS PrivateLink — Availability and failure modes](README.md#availability-and-failure-modes)
