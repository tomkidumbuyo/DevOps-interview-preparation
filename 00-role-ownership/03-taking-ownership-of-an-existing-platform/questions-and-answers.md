...
> **Covered in:** [Taking ownership of an existing platform — Complete curriculum checklist](README.md#complete-curriculum-checklist)
...
> **Covered in:** [Taking ownership of an existing platform — Easy mode: mental model](README.md#easy-mode-mental-model)
...
> **Covered in:** [Taking ownership of an existing platform — Command and configuration lab](README.md#command-and-configuration-lab)
...
> **Covered in:** [Taking ownership of an existing platform — Beginner → mid-level → senior learning path](README.md#beginner-mid-level-senior-learning-path)
