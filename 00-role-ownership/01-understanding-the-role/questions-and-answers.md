...
> **Covered in:** [Understanding the role — Complete curriculum checklist](README.md#complete-curriculum-checklist)
...
> **Covered in:** [Understanding the role — Command and configuration lab](README.md#command-and-configuration-lab)
...
> **Covered in:** [Understanding the role — Beginner → mid-level → senior learning path](README.md#beginner-mid-level-senior-learning-path)
...
**Reading path:** [← Back: Interview and role-ownership framework](../README.md) · [Study note](README.md) · [Next: Senior engineering expectations →](../02-senior-engineering-expectations/README.md)
